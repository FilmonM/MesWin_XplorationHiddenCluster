...
d3.button = function() {
  ...
  // define attributes and positioning for the button
  var padding = 8,
      radius = 1,
      stdDeviation = 5,
      offsetX = 2,
  ...
  // function to place the button in the graph
  ...
  // functions to display reactions on click, mouseover or mouseout 
...
// Measurements of the graph    
var margin = {top: 40, right: 20, bottom: 30, left: 40},
    /// width and height will be generated by R automatically
    width = width - margin.left - margin.right,
    height = height - margin.top - margin.bottom;

// Formating the inputs to enhance readability
...
// Define tip output from barplot
var tip = d3.tip()
  .attr('class', 'd3-tip')
  .offset([-10, 0])
  .html(function(d) {
...
// Defining already established SVG object
...
// Define color gradient for bars
var colors = ['#2a8c37', '#aacf9c']
...
// Function to enable reset ability
var fnA = function(){ Shiny.setInputValue("bar_scatter_clicked", null); }

// Define linkt between button and reset function
...
// Enable button activity     
  ...
  .append("g")
  .attr("class", "button")
  .on('click', (d) => Shiny.setInputValue("bar_scatter_clicked", null))
  .call(button);
...
/*      .on('click', function(d){
      ...
      .on('click', (d) => Shiny.setInputValue("bar_scatter_clicked", d.DimensionName))
          ;
/*      .on('click', function(){
